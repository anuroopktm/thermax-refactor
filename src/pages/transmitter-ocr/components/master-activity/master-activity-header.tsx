...
import { AddMasterActivityDialog } from "./add-master-activity-dialog";

interface MasterActivityHeaderProps {
  totalResults: number;
}

export function MasterActivityHeader({
  totalResults,
}: MasterActivityHeaderProps) {
