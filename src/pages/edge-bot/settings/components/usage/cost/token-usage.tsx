...
import {
  useTokenUsage,
  useUpdateUsageLimit,
} from "@/services/query/edge-bot/usage.service";
  ...
  return (
    <Card className="flex flex-col">
      ...
      <CardFooter className="flex-col gap-4 text-center">
        <TokenUsageStats
          isLoading={isTokenLoading}
          totalSpent={tokenUsage?.totalSpent || 0}
...
interface TokenUsageChartProps {
  isLoading: boolean;
  usedPercent: number;
  pieData: Array<{ key: string; label: string; value: number; fill: string }>;
}

const TokenUsageChart = memo(function TokenUsageChart({
  isLoading,
  usedPercent,
  pieData,
...
const TokenUsageStats = memo(function TokenUsageStats({
  isLoading,
  totalSpent,
  limit,
