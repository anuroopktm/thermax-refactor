...
import { ChildActivityItemView } from "@/pages/transmitter-ocr/sections/child-activity-item-view.tsx";
        ...
        <Routes>
          ...
          <Route element={<DashboardLayout />}>
            ...
            <Route path="/transmitter-ocr" element={<TransmitterOcrPage />}>
              ...
              />
              <Route
                path="child-activity/:id/:itemId"
                element={<ChildActivityItemView />}
              />
