export const thermaxGptKeys = {
  ...
  chat: {
    ...
    list: (params?: Record<string, unknown>) =>
      ["thermax-gpt", "chat", "list", ...(params ? [params] : [])] as const,
    messages: (id?: string) =>
      ["thermax-gpt", "chat", "messages", ...(id ? [id] : [])] as const,
  },
  members: {
    all: ["thermax-gpt", "members"] as const,
    me: () => ["thermax-gpt", "members", "me"] as const,
    list: (params?: Record<string, unknown>) =>
      ["thermax-gpt", "members", "list", ...(params ? [params] : [])] as const,
  },
  usage: {
    ...
    cost: {
      ...
      list: (params?: Record<string, unknown>) =>
        ["thermax-gpt", "usage", "cost", ...(params ? [params] : [])] as const,
